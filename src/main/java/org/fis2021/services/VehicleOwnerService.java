...
public class VehicleOwnerService {
    ...
    public static void checkVehicleOwnerDoesNotAlreadyExist(String username) throws UsernameAlreadyExistsException {
    ...
    public static List<VehicleOwner> getAllVehicleOwners() {
        return vehicleOwnerRepository.find().toList();
    }
